              ...
              <div class="row">
                <div class="col-md-8 order-md-2 col-lg-9">
                      ...
                      <div class="col-6 col-md-6 col-lg-4 mb-3">
                        <div class="card h-100 border-0">
                          <div class="card-img-top">
                              ...
                              @else
                                  <img src="https://via.placeholder.com/240x240/5fa9f8/efefef" class="img-fluid mx-auto d-block" alt="Zdjęcię">
                              @endif               
                          </div>
                 ...
                 @endforeach
                  ...
                  <div class="divider mt-5 mb-5 border-bottom border-secondary"></div>
                  <a href="#" class="btn btn-lg btn-block btn-primary mt-5 delete" id="" >{{ __('shop.welcome.filtr') }}</a>
                </div>
...
@section('js-files')
<script src="{{ asset('js/delete_copy.js') }}"></script>
@endsection
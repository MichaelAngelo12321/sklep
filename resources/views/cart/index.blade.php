                    ...
                    <div class="col-lg-10 offset-lg-1">
                        <div class="cart_container">
                                    ...
                                    <li class="cart_item clearfix">
                                        ...
                                        <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                            ...
                                            <div class="cart_item_total">
                                                <button class="btn btn-danger btn-sm delete" data-id="{{ $item->getProductId() }}"><i class="fa-solid fa-trash-can"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="cart_buttons"> <a href="/" class="button cart_button_clear">Wróć do sklepu</a>
                                <button type="button" class="button cart_button_checkout" disabled>Zapłać</button> </div>
                        </div>
                    </div>
                </div>
            </div>
